<div class="question">
        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <?php echo do_shortcode('[contact-form-7 id="124" title="Форма вопрос"]') ?>   
            </div>
        </div>
        <footer>
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="footer__social">
                            ...
                            <a href="<?php the_field('link_to_inst', 2)?>" class="footer__social-item">
                            ...
                            <a href="<?php the_field('link_to_fb', 2)?>" class="footer__social-item">
                            ...
                            <a href="<?php the_field('link_to_youtube', 2)?>" class="footer__social-item">
                        ...
                        <div class="footer__contacts">
                            <div class="footer__contacts-item">
                                ...
                                <div class="footer__contacts-tel">
                                    <a href="tel:<?php the_field('tel_in_footer1', 2)?>"><?php the_field('tel_in_footer1', 2)?></a>
                                    <a href="tel:<?php the_field('tel_in_footer2', 2)?>"><?php the_field('tel_in_footer2', 2)?></a>
                                </div>
                            </div>
                            <div class="footer__contacts-item">
                                <img src="<?php echo bloginfo("template_url");?>/assets/img/icons/svg/pointer.svg" alt="указатель" class="footer__contacts-logo">
                                <address><?php the_field('address_in_footer', 2)?></address>
                            </div>
                        </div>
                    </div>
                </div>
