        ...
        <div class="row">
                    ...
                    <div class="contacts__phones">
                        <div class="contacts__phoneblock">
                            ...
                            <div class="contacts__phonewrap">
                                ...
                                <a href="tel:<?php the_field('contact_tel1') ?>"><?php the_field('contact_tel1') ?> </a>
                            </div>
                        </div>
                        <div class="contacts__phoneblock">
                            Телефон №2
                            <div class="contacts__phonewrap">
                                ...
                                <a href="tel:<?php the_field('contact_tel2') ?>"><?php the_field('contact_tel2') ?></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-6">
                ...
                <div class="contacts__feed">
                    <?php echo do_shortcode('[contact-form-7 id="123" title="Форма отзывов"]')?>
                </div>   
            </div>
        </div>
        <div class="row mt70">
